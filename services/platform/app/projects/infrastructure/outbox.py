"""Outbox table + writer for the `projects` schema (Outbox Pattern,
ADR-014) — identical mechanism to app.identity.infrastructure.outbox,
...
class OutboxMessageOrmModel(ProjectsBase):
    __tablename__ = "outbox_messages"
    __table_args__ = (
        Index("ix_projects_outbox_messages_published_at", "published_at"),
        {"schema": "projects"},
    )
