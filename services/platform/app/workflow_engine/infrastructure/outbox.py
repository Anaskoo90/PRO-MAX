"""Outbox table + writer for the `workflow_engine` schema (Outbox Pattern,
...
class OutboxMessageOrmModel(WorkflowEngineBase):
    __tablename__ = "outbox_messages"
    __table_args__ = (
        Index("ix_workflow_engine_outbox_messages_published_at", "published_at"),
