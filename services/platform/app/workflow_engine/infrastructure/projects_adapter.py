...
Boards'/Tasks' own ProjectsProjectContextAdapter — each context builds its
own ACL to Projects rather than importing another context's ACL.
"""
...
class ProjectsWorkflowContextAdapter:
